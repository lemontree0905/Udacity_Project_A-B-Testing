...
#### Recommendation
We can see that the Gross conversion represents both statistically and practically significant differences, while the Net conversion is neither statistically or practically significant. It means that the number of frustrated students who left the free trial has redueced but the number of students to continue past the free trial and eventually complete the course is unaffected. The hypothesis holds true and the change could help Udacity improve the overall student experience and improve coaches' capacity to support students who are likely to complete the course. Therefore I will recommend launch the change.
